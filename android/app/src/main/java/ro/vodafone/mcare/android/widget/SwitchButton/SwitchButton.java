...
/**
 * SwitchButton
 * Class taken from https://github.com/kyleduo/SwitchButton. For more informations please find on the coresponding link.
 *
 */
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            ...
            gdprSwitchStyle = ta.getBoolean(R.styleable.SwitchButton_kswGdprSwitchStyle, gdprSwitchStyle);
            ta.recycle();
        }
    ...
    public void setCheckedAndCallListener(final boolean checked) {
        if (isChecked() != checked) {
            animateToState(checked);
        }
        ...
        if (mRestoring) {
            ...
            super.setChecked(checked);
            if (isChecked() == checked) {
                mChildOnCheckedChangeListener.onCheckedChanged(this, checked);
            }
        }
    }

//    public void setCheckedNoAnimation(final boolean checked) {
//        // animate before super.setChecked() become user may call setChecked again in OnCheckedChangedListener
//        cancelPositionAnimator();
//
//        setCheckedNoEvent(checked);
//
//    }
    ...
    public void toggleImmediately(boolean b) {
    ...
    public void setMyStyle() {
        ...
        int[][] states = new int[][]{
                new int[]{android.R.attr.state_checked, android.R.attr.state_enabled}, // enabled
                new int[]{-android.R.attr.state_checked, android.R.attr.state_enabled}, // disabled
        };

        int[] colors = new int[]{
                Color.parseColor("#028091"),
                Color.parseColor("#d6d6d6"),
        };


        setBackColor(new ColorStateList(states, colors));

    }

    public void setGdprSwitchStyle() {
        setBackDrawableRes(R.drawable.track_selector_gdpr);
        setThumbDrawableRes(R.drawable.thumb_selector_gdpr);
    }
}