 ...
 * Postpaid user
 */
public class PrivateUser extends CBUUser {

    @Override
    public int getMenu() {
        return R.menu.postpaid_private_menu;
    }
    ...
    public List<SelectionPageButton> getTopUpSelectionPageButtons(Context context) {
        ...
        topUpSelectionPageButtons.add(new SelectionPageButton(context, ContextCompat.getColor(context, R.color.product_card_primary_dark_blue),
                TopUPLabels.getTop_up_recurent_recharge(), TopUPLabels.getTop_up_open_modify_recharge(), new TopUpRecurrentRechargesFragment(), null));
