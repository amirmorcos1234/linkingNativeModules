...
public class FinancialAccountViewHolder extends IdentityViewHolder {
    ...
    public FinancialAccountViewHolder(View itemView, Context context) {
        super(itemView);
    ...
    public void setData(ExpandableListTree.Node data){
        ...
        Glide.with(context)
                .load(R.drawable.default_avatar_icon)
