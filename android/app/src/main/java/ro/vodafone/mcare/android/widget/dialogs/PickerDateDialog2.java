...
/**
 * Created by cosmin deliu on 4/12/2018.
 */

public class PickerDateDialog2 extends DialogFragment implements
    ...
    private PickerDateDialog2.OnDateSetListener mCallBack;
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(PickerDateDialog2 view, int year, int monthOfYear, int dayOfMonth);
    }
     ...
     */
    public static PickerDateDialog2 newInstance(PickerDateDialog2.OnDateSetListener callBack, int year,
                                               int monthOfYear,
                                               int dayOfMonth) {
        PickerDateDialog2 ret = new PickerDateDialog2();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth);
        return ret;
    }

    public void initialize(PickerDateDialog2.OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        mCallBack = callBack;
    ...
    public void updateDisplay(boolean announce) {
    ...
    @SuppressWarnings("unused")
    public void setOnDateSetListener(PickerDateDialog2.OnDateSetListener listener) {
        mCallBack = listener;
    }
    ...
    public void notifyOnDateListener() {
        if (mCallBack != null) {
            mCallBack.onDateSet(PickerDateDialog2.this, mCalendar.get(Calendar.YEAR),
