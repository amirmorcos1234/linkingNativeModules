...
import ro.vodafone.mcare.android.ui.views.nonscrollable.NonScrollAbleListView;

/**
 * Created by bogdan.marica on 3/6/2017.
 */

public class SwipeMenuListView extends NonScrollAbleListView {
    ...
    public void setAdapter(ListAdapter adapter) {
        super.setAdapter(new SwipeMenuAdapter(getContext(), adapter, scrollView) {
            @Override
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                View childView = getChildAt(mTouchPosition - getFirstVisiblePosition());
                ...
                if (childView instanceof SwipeMenuLayout) {
                    mTouchView = (SwipeMenuLayout) childView;
                    mTouchView.setSwipeDirection(mDirection);
                }
                if (mTouchView != null) {
                    mTouchView.onSwipe(ev);
    ...
    public void setParentScrollview(LockableScrollView scrollview) {
