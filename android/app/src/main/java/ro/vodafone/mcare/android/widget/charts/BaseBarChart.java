...
public abstract class BaseBarChart extends BaseChart {
    ...
    public BaseBarChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mShowValues         = a.getBoolean(org.eazegraph.lib.R.styleable.BaseBarChart_egShowValues,         DEF_SHOW_VALUES);
            mBarWidth           = a.getDimension(org.eazegraph.lib.R.styleable.BaseBarChart_egBarWidth,         Utils.dpToPx(DEF_BAR_WIDTH));
            mBarMargin          = a.getDimension(org.eazegraph.lib.R.styleable.BaseBarChart_egBarMargin,        Utils.dpToPx(DEF_BAR_MARGIN));
            mFixedBarWidth      = a.getBoolean(org.eazegraph.lib.R.styleable.BaseBarChart_egFixedBarWidth,      DEF_FIXED_BAR_WIDTH);
            mScrollEnabled      = a.getBoolean(org.eazegraph.lib.R.styleable.BaseBarChart_egEnableScroll,       DEF_SCROLL_ENABLED);
            mVisibleBars        = a.getInt(org.eazegraph.lib.R.styleable.BaseBarChart_egVisibleBars,            DEF_VISIBLE_BARS);
        } finally {
    ...
    private static final String LOG_TAG = org.eazegraph.lib.charts.BaseBarChart.class.getSimpleName();
