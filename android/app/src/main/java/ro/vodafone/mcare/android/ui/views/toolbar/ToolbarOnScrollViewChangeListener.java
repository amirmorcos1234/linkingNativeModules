...
public abstract class ToolbarOnScrollViewChangeListener implements ViewTreeObserver.OnScrollChangedListener {
    ...
    protected ToolbarOnScrollViewChangeListener(ScrollView nestedScrollView) {
