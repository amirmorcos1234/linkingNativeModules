...
public class SwipeMenuLayout extends FrameLayout {
    ...
    public SwipeMenuLayout(View contentView, SwipeMenuView menuView) {
        this(contentView, menuView, null, null, null);
    }

    public SwipeMenuLayout(View contentView, SwipeMenuView menuView,
                           Interpolator closeInterpolator, Interpolator openInterpolator, LockableScrollView scrollView) {
...
//                LayoutParams.WRAP_CONTENT));
        ...
        // mContentView.setBackgroundColorWithRes(Color.WHITE);
        // }
...
//        D.e("1");
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                dx = event.getX();
                dy = event.getY();
//                D.d("DONT DISABLE HERE DISABLED - FIND DIFFERENCE BETWEEN HOR AND VER SWIPE");
                isFling = false;
                break;
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(dy - event.getY()) > this.getHeight()) {
                    smoothCloseMenu();
                }else
...
//                D.d("HERE ENABLED");
    ...
    public void setMenuHeight(int measuredHeight) {
        D.w("pos = " + position + ", height = " + measuredHeight);
