package ro.vodafone.mcare.android.ui.utils.imagecontroller.cropoverlay.utils;
...
public class ImageViewUtil {
    ...
    public static void setGrayScaleImageFilter(ImageView imageView){
        if(imageView ==null){
            D.w("Trying to perform grayscale filter to null ImageView object");
            return;
        }
