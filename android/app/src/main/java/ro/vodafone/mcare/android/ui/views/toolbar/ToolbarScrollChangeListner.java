 ...
 */
public abstract class ToolbarScrollChangeListner implements ViewTreeObserver.OnScrollChangedListener {
    ...
    protected ToolbarScrollChangeListner(NestedScrollView nestedScrollView) {
