...
public class ChartValueSerie {
    ...
    public int mFillBottonColor = 0x00000000;
    public int mFillTopColor = 0x00000000;
    public float mWidth = 2;
    public float mBarWidth = 10;
     ...
     */
    public void addPoint(int index,ChartValue point){
        // update range first
        if (mAutoYminmax) {
            if (mPointList.size()>0) {
                if (point.y>mYmax) mYmax = point.y;
     ...
     */
    public void setStyle(int iColor,int botomColor, int topColor, float fWidth,float barWidth,boolean bUsedip) {
        mColor = iColor;
        mFillBottonColor = botomColor;
        mFillTopColor = topColor;
        mWidth = fWidth;
        mBarWidth = barWidth;
        mUseDip = bUsedip;
    }

    public void setBarStyle(int botomColor, int topColor, float barWidth) {
        mFillBottonColor = botomColor;
        mFillTopColor = topColor;
        mBarWidth = barWidth;
    }
